...
ignore: (<S> | <MLINE_COMMENT> | <SLINE_COMMENT>)+

statements: statement+

pub_func_decl: <PUB> ignore func_decl

func_decl: <DEF> ignore <TEXT>=func_name ignore func_args=func_args <CU>

func_args: <SMBRACKET_L> (<S>* (arg_decl <S>* ,))* <S>
